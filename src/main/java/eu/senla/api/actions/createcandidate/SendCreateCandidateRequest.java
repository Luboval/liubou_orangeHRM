...
public class SendCreateCandidateRequest {
    ...
    public static ApiResponse<CandidateApiResponse, Meta> sendCreateCandidateRequest(Object createCandidate) {
        return RequestManager.postRequestTypeRef(
                ...
                createCandidate,
                new TypeRef<ApiResponse<CandidateApiResponse, Meta>>() { }
        );
    }
}
